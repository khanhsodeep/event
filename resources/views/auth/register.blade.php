                    ...
                    <div class="modal-body">
                        <form method="POST" action="{{ route('register') }}" style="padding:50px;">
                            ...
                            <div class="form-group row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="fullname" type="text" pattern="[a-Z]*" class="form-control @error('fullname') is-invalid @enderror" name="fullname" value="{{ old('fullname') }}" required autocomplete="username" autofocus>
